...
WEB_CHAT_PROVIDER="disabled"
WEB_CHAT_BACKEND="playwright"
WEB_CHAT_HEADLESS="1"
WEB_CHAT_PROFILE_DIR="/data/web-chat"
...
GEMINI_SEARCH_PROVIDER=${GEMINI_SEARCH_PROVIDER}
GEMINI_SEARCH_SCRAPE_BACKEND=${GEMINI_SEARCH_SCRAPE_BACKEND}
WEB_CHAT_PROVIDER=${WEB_CHAT_PROVIDER}
WEB_CHAT_BACKEND=${WEB_CHAT_BACKEND}
WEB_CHAT_HEADLESS=${WEB_CHAT_HEADLESS}
WEB_CHAT_PROFILE_DIR=${WEB_CHAT_PROFILE_DIR}
